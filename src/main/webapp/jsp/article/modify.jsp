...
<body>
	...
	<div>제목: <input autocomplete="off" type="text" name = "title" placeholder="제목을 입력해주세요" value="<%=(String)articleRow.get("title") %>"/></div>
	<div>내용: <textarea autocomplete="off" name="body" placeholder="내용을 입력해주세요"><%=(String)articleRow.get("body") %></textarea></div>
	<div><button type="submit">수정</button><a href="list">리스트로 돌아가기</a></div>
	</form>
</body>
</html>